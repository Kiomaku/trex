...
public class GpsGui {
    ...
    public static void open(Player player) {
        ...
        for (String id : gps.getKeys(false)) {
            ...
            int fastTravelCost = KoyaGPS.getLocationFileManager().getConfig().getInt("Locations." + id + ".FastTravelCost", 100);
